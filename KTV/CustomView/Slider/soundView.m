...
@interface soundView ()<ASValueTrackingSliderDelegate> {
...
//    调音(1麦克风 2 音乐 3 功放 4音调 ) & value
    ...
    //add UISlider by kefoqing
    
    ASValueTrackingSlider *slider2 = [[ASValueTrackingSlider alloc] initWithFrame:CGRectMake(10, 0, SCREEN_WIDTH-20, 100)];
    slider2.center = CGPointMake(SCREENSIZE.width/2, 720);
    // customize slider 2
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
    [formatter setNumberStyle:NSNumberFormatterPercentStyle];
    [slider2 setNumberFormatter:formatter];
    slider2.font = [UIFont fontWithName:@"Futura-CondensedExtraBold" size:26];
    slider2.popUpViewAnimatedColors = @[[UIColor purpleColor], [UIColor redColor], [UIColor orangeColor]];
    slider2.popUpViewArrowLength = 20.0;
    [WINDOW addSubview:slider2];
    ...
    [UIView animateWithDuration:1 delay:0.2 options:UIViewAnimationOptionCurveEaseIn animations:^{
        slider2.center = CGPointMake(SCREENSIZE.width/2, SCREEN_HEIGHT/2);
